...
export default function Data(){
    return(
        <div className="home-data">
            <h1 className="home-title">Utkarsh Goswami
                <svg
                    width="36"
                    height="36"
                    viewBox="0 0 48 48"
            ...
            <p className="home-description">
                I'm a full stack developer with experience in working with Java, Python, and JavaScript, proficient in frontend and backend development. Explore my portfolio to see my technical prowess and dedication to high-quality results.
            </p>
