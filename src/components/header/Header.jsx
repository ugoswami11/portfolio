    ...
    return (
        <header className="header">
            <nav className="nav container">
                <a href="index.html" className='nav-logo'>Utkarsh</a>
                ...
                <div className={toggle ? "nav-menu show-menu": "nav-menu"}>
                    <ul className='nav-list grid'>
                        ...
                        <li className="nav-item">
                            <a href="#experience" onClick={()=> setActiveNav('#services')} className={activeNav === '#services' ? 'nav-link active-link' : 'nav-link'}>
                                <i className="uil uil-briefcase-alt nav-icon"></i>Experience
                            </a>
                        </li>
                        <li className="nav-item">
