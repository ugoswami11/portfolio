...
export default function Contact(){
    ...
    const sendEmail = (e) => {
        ...
        emailjs.sendForm('service_8cckc67', 'template_wofdxgv', form.current, '7868nw58MCpQfems2')
        // .then((result) => {
    ...
    return(
        <section className='contact section' id='contact'>
            ...
            <div className="contact-container container grid">
                <div className="contact-content">
                    ...
                    <div className="contact-info">
                        <div className="contact-card">
                            ...
                            <span className="contact-card-data">ugoswami1112@gmail.com</span>

                            <a href="mailto:ugoswami1112@gmail.com" className="contact-button">Write me {" "}
                    ...
                    <div className="contact-info">
                        <div className="contact-card">
                            ...
                            <span className="contact-card-data">900-679-2044</span>

                            <a href="https://wa.me/919006792044" className="contact-button">Write me 
                                <i className="bx bx-right-arrow-alt contact-button-icon"></i>
                            </a>
                    ...
                    <div className="contact-info">
                        <div className="contact-card">
                            ...
                            <span className="contact-card-data">ugoswami11</span>

                            <a href="https://twitter.com/messages/compose?recipient_id=995539671391256576" className="contact-button">Write me 
                                <i className="bx bx-right-arrow-alt contact-button-icon"></i>
                            </a>
                ...
                <div className="contact-content">
                    <h3 className="contact-title">Write me </h3>
